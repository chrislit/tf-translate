...
def prepare_data(data_dir, src_vocabulary_size, tar_vocabulary_size, tokenizer=None):
  ...
  Returns:
    A tuple of 6 elements:
      (1) path to the token-ids for source-text training data-set,
      (2) path to the token-ids for target-text training data-set,
      (3) path to the token-ids for source-text development data-set,
      (4) path to the token-ids for target-text development data-set,
      (5) path to the source-text vocabulary file,
      (6) path to the target-text vocabulary file.
  """
